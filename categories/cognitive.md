...
<section class="hero hero-compact">
  ...
  <h1>Cognitive</h1>
  <p class="hero-copy">Biases, perception, memory, reasoning, and self-monitoring. This page currently lists <strong>7 models</strong>.</p>
...
<div class="card-grid">
  <article class="model-card">
    <h3><a href="{{ '/models/cognitive/anchoring-effect.md' | relative_url }}">---</a></h3>
  ...
  <article class="model-card">
    <h3><a href="{{ '/models/cognitive/availability-heuristic.md' | relative_url }}">---</a></h3>
  ...
  <article class="model-card">
    <h3><a href="{{ '/models/cognitive/cognitive-dissonance.md' | relative_url }}">---</a></h3>
  ...
  <article class="model-card">
    <h3><a href="{{ '/models/cognitive/confirmation-bias.md' | relative_url }}">---</a></h3>
  ...
  <article class="model-card">
    <h3><a href="{{ '/models/cognitive/dunning-kruger.md' | relative_url }}">---</a></h3>
  ...
  <article class="model-card">
    <h3><a href="{{ '/models/cognitive/halo-effect.md' | relative_url }}">---</a></h3>
  ...
  <article class="model-card">
    <h3><a href="{{ '/models/cognitive/metacognition.md' | relative_url }}">---</a></h3>
