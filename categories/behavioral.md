...
<section class="hero hero-compact">
  ...
  <h1>Behavioral</h1>
  <p class="hero-copy">Habits, conditioning, reinforcement, motivation, and learned behavior. This page currently lists <strong>6 models</strong>.</p>
...
<div class="card-grid">
  <article class="model-card">
    <h3><a href="{{ '/models/behavioral/classical-conditioning.md' | relative_url }}">---</a></h3>
  ...
  <article class="model-card">
    <h3><a href="{{ '/models/behavioral/habit-loop.md' | relative_url }}">---</a></h3>
  ...
  <article class="model-card">
    <h3><a href="{{ '/models/behavioral/operant-conditioning.md' | relative_url }}">---</a></h3>
  ...
  <article class="model-card">
    <h3><a href="{{ '/models/behavioral/self-determination-theory.md' | relative_url }}">---</a></h3>
  ...
  <article class="model-card">
    <h3><a href="{{ '/models/behavioral/self-perception-theory.md' | relative_url }}">---</a></h3>
  ...
  <article class="model-card">
    <h3><a href="{{ '/models/behavioral/temptation-bundling.md' | relative_url }}">---</a></h3>
